...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openSettings() {
    alert("Settings page will be available here.");
  }
  ...
  editProfileBtn.addEventListener("click", () => {
    const currentName = localStorage.getItem("profileName") || "Music Lover";

    const currentEmail =
      localStorage.getItem("profileEmail") || "musicplayer@example.com";
    ...
    const email = prompt("Enter your email:", currentEmail);
    ...
    const cleanEmail = email.trim() || "musicplayer@example.com";

    localStorage.setItem("profileName", cleanName);

    localStorage.setItem("profileEmail", cleanEmail);
